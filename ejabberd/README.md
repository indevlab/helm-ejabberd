# InDevLab ejabberd distribution
...
### Elector service to define a leader pod
...
version. For `24.12`, it would be:
https://github.com/processone/ejabberd/blob/24.12/sql/pg.new.sql
...
## Adding the helm repository
    ...
    helm repo add ejabberd https://indevlab.github.io/helm-ejabberd
