{{- define "ejabberd.podTemplate" }}
    ...
    spec:
      ...
      - name: init-copy-certs
        ...
        args:
          - >-
            ...
            echo ">> Copy config files to /home/ejabberd/conf" ;
            cp /tmp/conf/* /home/ejabberd/conf ;
            echo ">> Copying config files complete!" ;
            echo ">> Copy TLS certs to /home/ejabberd/certs" ;
            cp -r /tmp/certs/* /home/ejabberd/certs ;
      ...
      - image: {{ template "ejabberd.image-name" . }}
        ...
        {{- range $name := .Values.certFiles.secretName }}
          - name: ejabberd-certs-{{ $name | replace "." "-" }}
            mountPath: /home/ejabberd/certs/{{ $name }}
            readOnly: true
        {{- end }}
        {{- end }}
          - name: mnesia
